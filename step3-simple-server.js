...
function write_error(res,fileError)
{
    res.writeHead(404,{
...
server.listen(3030,"localhost",error => error ? console.log("Error ", error) : console.log("Server is now live on localhost:3030"))